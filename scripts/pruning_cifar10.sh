...
CUDA_VISIBLE_DEVICES=$1 python  pruning_cifar10.py  ./data/cifar.python --dataset cifar10 --arch resnet50 \
--save_path $2 \
--epochs 200 \
--schedule  60 120 160 \
--gammas 0.2 0.2 0.2 \
...
CUDA_VISIBLE_DEVICES=$0,1,2,3 python  pruning_cifar10.py  ./data/cifar.python/cifar10 --dataset cifar10 --arch resnet56 \
--save_path $2 \
--epochs 200 \
--schedule 60 120 160 \
--gammas 0.2 0.2 0.2 \
